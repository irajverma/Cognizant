...
VALUES ('John Doe', 75000.0, true, '1990-05-15', 1);
INSERT INTO employee (em_name, em_salary, em_permanent, em_date_of_birth, em_dp_id) 
VALUES ('Jane Smith', 85000.0, true, '1988-10-22', 1);
INSERT INTO employee (em_name, em_salary, em_permanent, em_date_of_birth, em_dp_id) 
VALUES ('Mark Taylor', 50000.0, false, '1995-03-12', 2);
INSERT INTO employee (em_name, em_salary, em_permanent, em_date_of_birth, em_dp_id) 
VALUES ('Emily Davis', 95000.0, true, '1985-12-01', 3);
...
INSERT INTO employee_skill (es_em_id, es_sk_id) VALUES (1, 1); -- John: Java
INSERT INTO employee_skill (es_em_id, es_sk_id) VALUES (1, 3); -- John: SQL
INSERT INTO employee_skill (es_em_id, es_sk_id) VALUES (2, 1); -- Jane: Java
INSERT INTO employee_skill (es_em_id, es_sk_id) VALUES (2, 2); -- Jane: Spring Boot
INSERT INTO employee_skill (es_em_id, es_sk_id) VALUES (2, 3); -- Jane: SQL
INSERT INTO employee_skill (es_em_id, es_sk_id) VALUES (3, 3); -- Mark: SQL
INSERT INTO employee_skill (es_em_id, es_sk_id) VALUES (3, 4); -- Mark: React

-- Quiz Sample Data: Users
INSERT INTO user (us_name, us_email) VALUES ('Alice', 'alice@gmail.com');
INSERT INTO user (us_name, us_email) VALUES ('Bob', 'bob@gmail.com');

-- Quiz Sample Data: Questions
INSERT INTO question (qt_text, qt_score) VALUES ('What is the extension of the hyper text markup language file?', 1.0);
INSERT INTO question (qt_text, qt_score) VALUES ('What is the maximum level of heading tag can be used in a HTML page?', 1.0);
INSERT INTO question (qt_text, qt_score) VALUES ('The HTML document itself begins with <html> and ends </html>. State True of False', 1.0);
INSERT INTO question (qt_text, qt_score) VALUES ('Choose the right option to store text value in a variable', 1.0);

-- Quiz Sample Data: Options
-- Q1 options
INSERT INTO options (op_qt_id, op_text, op_is_correct) VALUES (1, '.xhtm', false);
INSERT INTO options (op_qt_id, op_text, op_is_correct) VALUES (1, '.ht', false);
INSERT INTO options (op_qt_id, op_text, op_is_correct) VALUES (1, '.html', true);
INSERT INTO options (op_qt_id, op_text, op_is_correct) VALUES (1, '.htmx', false);
-- Q2 options
INSERT INTO options (op_qt_id, op_text, op_is_correct) VALUES (2, '5', false);
INSERT INTO options (op_qt_id, op_text, op_is_correct) VALUES (2, '3', false); -- user got this but it's false
INSERT INTO options (op_qt_id, op_text, op_is_correct) VALUES (2, '4', false);
INSERT INTO options (op_qt_id, op_text, op_is_correct) VALUES (2, '6', true);
-- Q3 options
INSERT INTO options (op_qt_id, op_text, op_is_correct) VALUES (3, 'false', false);
INSERT INTO options (op_qt_id, op_text, op_is_correct) VALUES (3, 'true', true);
-- Q4 options
INSERT INTO options (op_qt_id, op_text, op_is_correct) VALUES (4, "'John'", true);
INSERT INTO options (op_qt_id, op_text, op_is_correct) VALUES (4, 'John', false);
INSERT INTO options (op_qt_id, op_text, op_is_correct) VALUES (4, '"John"', false);
INSERT INTO options (op_qt_id, op_text, op_is_correct) VALUES (4, '/John/', false);

-- Quiz Sample Data: Attempt (Alice, ID 1)
INSERT INTO attempt (at_us_id, at_date) VALUES (1, '2026-06-20 07:00:00');

-- Attempt Questions for Attempt 1 (Alice)
INSERT INTO attempt_question (aq_at_id, aq_qt_id) VALUES (1, 1); -- Q1
INSERT INTO attempt_question (aq_at_id, aq_qt_id) VALUES (1, 2); -- Q2
INSERT INTO attempt_question (aq_at_id, aq_qt_id) VALUES (1, 3); -- Q3
INSERT INTO attempt_question (aq_at_id, aq_qt_id) VALUES (1, 4); -- Q4

-- Attempt Options (Alice's answers)
INSERT INTO attempt_option (ao_aq_id, ao_op_id) VALUES (1, 3); -- Answer Q1: .html (correct)
INSERT INTO attempt_option (ao_aq_id, ao_op_id) VALUES (2, 6); -- Answer Q2: 3 (incorrect)
INSERT INTO attempt_option (ao_aq_id, ao_op_id) VALUES (3, 10); -- Answer Q3: true (correct)
INSERT INTO attempt_option (ao_aq_id, ao_op_id) VALUES (4, 11); -- Answer Q4: 'John' (correct)
